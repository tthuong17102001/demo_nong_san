...
import com.example.demonongsan.service.impl.OrderedServiceImpl;
import com.example.demonongsan.service.impl.TransactionServicesImpl;
...
public class ServletTransaction extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect(req.getContextPath() + "/ServletCheckout");
