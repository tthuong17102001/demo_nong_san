        ...
        <div class="container">
            <div class="aa-catg-head-banner-content">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="${pageContext.request.contextPath}/ServletProductListClient">Sản phẩm</a></li>
                            ...
                            <c:otherwise>
                                <c:out value="Hết hàng"/>
                                    ...
                                    <div class="aa-prod-view-bottom">
                                        <a class="aa-add-to-cart-btn" href="${pageContext.request.contextPath}/ServletAddtoCart?product-id=${detail_product.id}">Thêm vào giỏ hàng</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade " id="review">
                                <div class="aa-product-review-area">
                                    ...
                                    <!-- review form -->
                                    <form action="${pageContext.request.contextPath}/ServletReviewClient?id=${detail_product.id}" method="post" class="aa-review-form">
                    ...
                    <div class="aa-product-related-item">
                        ...
                        <ul class="aa-product-catg aa-related-item-slider">
                            ...
                            <c:forEach items="${productById}" var="product">
                                <li>
                                    <figure>
                                        <a class="aa-product-img" href="${pageContext.request.contextPath}/ServletProductDetail?id=${product.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt=""></a>
